...
urlpatterns = [
    ...
    path('order_items/', order_views.OrderItemCreateView.as_view(), name='order-item-list-create'),
    path('order_items/<int:pk>/', order_views.OrderItemDetailView.as_view(), name='order-item-detail'),
